...
/**
 * ImageLab is a platform for image filter development.  ImageLab begins by
 * building a menu of all available filters (those .class files that implement
 * the {@see ImageFilter ImageFilter} interface). [TODO: User interface to allow
 * chosing directory to search for filters. [TODO: User interface to allow
 * displaying images a line or pixel at a time.
 *
...
public class ImageLab {
  ...
  /**
   * Return a File menu for a single image. Provides "Play", "Save" and
   * "Close".
   *
  ...
  /**
   * Return a Filter menu for a single image. Provides access to all filters.
   *
  ...
  public static ActionListener makeActionListener(ImageFilter imf) {
    ...
    return new ActionListener() {
      public void actionPerformed(ActionEvent ev) {
        if (impro == null) {
          JOptionPane
              .showMessageDialog(myframe, "You must first select an image");
          return;
        }
  ...
  public static ActionListener makeOpenListener() {
    return new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ImgProvider
            improvider;                 //an imgProvider to hold the image
        FileDialog fd;
        fd = new FileDialog(frame, "Pick an image", FileDialog.LOAD);
        fd.setVisible(true);
        String theFile = fd.getFile();
  ...
  public static ActionListener makePlayListener() {
    ...
    return new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (improvider == null) {
          JOptionPane
              .showMessageDialog(myframe, "First select the image to play");
          return;
        }//if
        improvider.play();
      }//actionPerformed
  ...
  public static ActionListener makeSaveListener() {
    ...
    return new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ImgProvider improvider =
            impro;         //an imgProvider to hold the image
        if (improvider == null) {
