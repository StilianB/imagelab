...
/**
 * DynaPanel is a class to allow for dynamically displaying images. For use as a
 * singleton, ignore the constructor and use getDynPan() to retrieve the
 * singleton object each time.
 *
 * @author Dr. Jody Paul
 * @version 1.1
 */
