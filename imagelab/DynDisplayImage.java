...
/**
 * Graphics frame used for dynamic display of an image. For use as a singleton,
 * ignore the constructor and use getDynDisplay() to retrieve the singleton
 * object each time.
 *
 * @author Dr. Jody Paul
 * @version 1.1.1
...
public class DynDisplayImage extends DisplayImage {
  ...
  /**
   * This constructor takes the image object to display and a string to use as
  ...
  /**
   * This constructor takes the image object to display, a string to use as the
   * title of the window, and a third parameter that indicates that the display
   * is to be done a line at a time.
   *
   * @param imp   the image object to display
   * @param title the window title
