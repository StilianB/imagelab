...
/**
 * A musical scale. Comprised of an ordered set of pitches (midi note numbers).
 *
 * @author Dr. Jody Paul
 * @version 1.2
 */
public class Scale {
    ...
    /**
     * Access a specified pitch in this scale. The index used is the parameter
     * modulo the number of pitches in the scale.
     *
